...
#        self.hb0.SetBackgroundColour((200, 200, 200))  # set text back color
    ...
    def populate_logger_strip(self):
        ...
        self.screen_log = wx.TextCtrl(self.panel, wx.ID_ANY, size=(x, y), style=style)
        ...
        self.hbox_EL.Add(self.screen_log, (1, 1))
...
#        self.hbox4.Add(self.disp_text4["TS"], border=5, flag=wx.ALL | wx.ALIGN_CENTER_VERTICAL)
        ...
        self.disp_BaseName = RollingDialBox(self.panel, -1, "-- Ship ----- Year ------ Trip ---- Set -- ",
                                            self.data.basename, 220,"FOREST GREEN",wx.HORIZONTAL,afontmiddle)
...
# if thye use the warp button to enable the warp enter box
...
#        WINAQU_GUI_BONGO.main()
    ...
    def OnAbout(self,event):
        ...
        info.SetDevelopers (["D. Senciall ,  Feb 08 2018",
                             "\nScience Branch",
